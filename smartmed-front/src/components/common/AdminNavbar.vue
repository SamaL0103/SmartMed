...
<template>
  <nav class="navbar-glass">
    <div class="navbar-left">
      ...
      <router-link to="/admin/dashboard" class="nav-link">首页</router-link>
      <router-link to="/admin/diseases" class="nav-link">疾病信息</router-link>
      <router-link to="/admin/medicines" class="nav-link">药品信息</router-link>
      <router-link to="/admin/feedbacks" class="nav-link">反馈管理</router-link>
